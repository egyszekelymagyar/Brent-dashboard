...
# =================================================================
# 1. VERZIÓ ELLENŐRZÉS ÉS MEMÓRIA
# =================================================================
DATA_FILE = "brent_trend_v5_final.json"
VERSION = "TREND-RADAR V5.1 (AKTÍV)"
...
# 3. UI KONFIGURÁCIÓ
# =================================================================
st.set_page_config(page_title="BRENT TREND RADAR", layout="wide")
...
if not data.empty:
    ...
    # Közeledő fordulat figyelése (Viharjelző)
    gap = abs(ema_fast - ema_slow)
    is_warning = gap < (curr_p * 0.0002) # 0.02% alatti résnél riaszt
    ...
    # VIHARJELZŐ (Zárási figyelmeztetés)
